...
public class AgendamentoController {
    ...
    public ModelAndView editar(@PathVariable("id") Long id) {
        ...
        var request = new EditarAgendamentoRequest(agendamento.getId(), agendamento.getCliente(),agendamento.getDataHora(), agendamento.getProcedimento(), agendamento.getValor());
